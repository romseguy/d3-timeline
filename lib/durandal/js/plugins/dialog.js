    ...
    */
    ...
    dialog = {
        ...
        install: function (config) {
            app.showDialog = function (obj, activationData, context, settings) {
                settings = settings || {};
                var tmp = dialog.getContext(context);
                tmp.fixedHeader = settings.fixedHeader || false;
                tmp.backdrop = settings.backdrop || false;
                tmp.keyboard = settings.keyboard || false;
